...
if __name__ == "__main__":
    ...
    model_config = get_config_single(os.path.join(config["trained_model"]))
    ...
    if model_config.get("model_checkpoint_from_huggingface",False):
        model.from_pretrained(config["trained_model"])
    ...
    token_dimensions = model.get_output_dim()
    ...
    try:
        ...
        indexer = FaissDynamicIndexer(config,token_dimensions)
