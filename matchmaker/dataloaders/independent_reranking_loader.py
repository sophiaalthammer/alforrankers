...
class IndependentReRankingDatasetReader(DatasetReader):
    ...
    def text_to_instance(self, query_id:str, doc_id:str, query_sequence: str, doc_sequence: str,doc_title) -> Instance:  # type: ignore
        ...
        if self.token_type == "huggingface":
            ...
            query_field = CustomTransformerTextField(**query_tokenized,padding_token_id=self._tokenizer._tokenizer.pad_token_id)
        ...
        if self.token_type == "huggingface":
            ...
            doc_field = CustomTransformerTextField(**doc_tokenized,padding_token_id=self._tokenizer._tokenizer.pad_token_id)
