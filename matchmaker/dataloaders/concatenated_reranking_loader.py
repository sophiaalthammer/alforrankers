...
class ConcatenatedReRankingDatasetReader(DatasetReader):
    ...
    def text_to_instance(self, query_id: str, doc_id: str, query_sequence: str, doc_sequence: str, qa_spans: str) -> Instance:  # type: ignore
        ...
        doc_tokenized = self._tokenizer.tokenize(query_sequence,doc_sequence,self.max_query_length + self.max_doc_length)
        ...
        ret_instance = {
            ...
            "doc_id": doc_id_field,
            "doc_tokens": CustomTransformerTextField(**doc_tokenized)}
