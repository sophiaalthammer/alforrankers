...
parser.add_argument('--out-file', action='store', dest='out_file',
                    help='output folder', required=False,default="/mnt/c/Users/salthamm/Documents/phd/data/beir/hotpotqa" )
...
# for hotpot i can also download the train and dev set! do that later, now only the test sets!
